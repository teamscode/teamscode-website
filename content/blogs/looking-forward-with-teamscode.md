...
We still have our goal of growth, but now we also have to manage an internal transition as TeamsCode's founders (Chris and Alan) are moving on to college. We have many ideas, and are continuing to pursue collaboration with other students in order to grow the organization and host more events. We're considering reaching out to <a class="a" href="https://hackclub.com">Hack Club</a>, hosting other events (including bootcamps, hackathons, or development challenges), and advertising our <a class="a" href="https://archive.teamscode.org/learn/programming-practice/">Programming Practice platform</a> to reach more students. Most of all, we're looking to continue building TeamsCode with an open mindset and an ambitious team.
