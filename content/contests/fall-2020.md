...
<div style="float: right; margin-right: -20px; margin-left: 30px; text-align: center;">
  ...
  <br>
  <a href="https://codewithus.com"><img src="/images/partners/codewithus.png" alt="CodeWithUs" style="width: 220px; margin-bottom: 30px; margin-right: 20px; display block;"></a>
...
# Contest Files #
[Test cases and expected outputs](https://teamscode.blob.core.windows.net/public-files/TC2020_Fall_CasesSols_Combined.zip)  
